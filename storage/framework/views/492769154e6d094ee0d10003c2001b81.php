...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  ...
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
    ...
    <div class="d-flex align-items-center gap-2">
      <a href="<?php echo e(route('staff.registrar.accounts-oversight')); ?>" class="btn btn-outline-secondary btn-sm" title="Accounts Oversight">
        <i class="ri-eye-line me-1"></i> Accounts Oversight
      </a>
      <a href="<?php echo e(route('staff.registrar.reminders.index')); ?>" class="btn btn-outline-info btn-sm" title="Reminders">
      ...
      <div class="zmc-card h-100 border-success">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            ...
            <div class="h3 fw-black mb-0"><?php echo e($k['approved_today'] ?? 0); ?></div>
          </div>
          <div class="icon-box text-success"><i class="ri-check-double-line"></i></div>
        </div>
        <div class="mt-2 small text-muted">Week: <?php echo e($k['approved_this_week'] ?? 0); ?></div>
      </div>
    </div>
        ...
        <div class="zmc-card h-100 border-info">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="h3 fw-black mb-0 text-info"><?php echo e($k['forwarded_to_registrar'] ?? 0); ?></div>
                </div>
        ...
        <div class="zmc-card h-100 border-warning">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="h3 fw-black mb-0 text-warning"><?php echo e($k['fix_requests'] ?? 0); ?></div>
                </div>
    ...
    <form action="<?php echo e(url()->current()); ?>" method="GET" class="row g-2 align-items-end">
        ...
        <div class="col-md-2">
            ...
            <select name="status" class="form-select form-select-sm">
                ...
                <option value="paid_confirmed" <?php echo e(request('status') == 'paid_confirmed' ? 'selected' : ''); ?>>Paid Confirmed</option>
                <option value="registrar_review" <?php echo e(request('status') == 'registrar_review' ? 'selected' : ''); ?>>Registrar Review</option>
                <option value="approved_awaiting_payment" <?php echo e(request('status') == 'approved_awaiting_payment' ? 'selected' : ''); ?>>Awaiting Payment</option>
                <option value="forwarded_to_registrar" <?php echo e(request('status') == 'forwarded_to_registrar' ? 'selected' : ''); ?>>Forwarded to Registrar</option>
                <option value="registrar_fix_request" <?php echo e(request('status') == 'registrar_fix_request' ? 'selected' : ''); ?>>Fix Request</option>
                <option value="registrar_approved" <?php echo e(request('status') == 'registrar_approved' ? 'selected' : ''); ?>>Approved</option>
                <option value="returned_to_officer" <?php echo e(request('status') == 'returned_to_officer' ? 'selected' : ''); ?>>Returned to Officer</option>
            </select>
        </div>
        <div class="col-md-3">
      ...
      <table class="table table-hover align-middle mb-0 zmc-mini-table">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <tr>
            ...
            <td>
              <span class="small fw-bold text-uppercase"><?php echo e($type); ?></span>
              <?php
                $reqType = $app->request_type ?? 'new';
                $reqBadge = match($reqType) { 'renewal' => 'warning', 'replacement' => 'info', default => 'success' };
              ?>
              <span class="badge bg-<?php echo e($reqBadge); ?> ms-1"><?php echo e(ucfirst($reqType)); ?></span>
            </td>
            ...
            <td class="text-end">
              <div class="zmc-action-strip">
                ...
                <?php if($canFixRequest): ?>
                <button
                  type="button"
                  class="btn btn-sm zmc-icon-btn btn-outline-secondary js-open-modal"
                  data-target="#fixRequestModal<?php echo e($app->id); ?>"
                  data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <?php if($canPushToAccounts): ?>
                <button
                  type="button"
                  class="btn btn-sm zmc-icon-btn btn-outline-info js-open-modal"
                  data-target="#pushToAccountsModal<?php echo e($app->id); ?>"
                  data-bs-toggle="tooltip" data-bs-placement="top"
          ...
          <?php $__env->startPush('zmc_modals'); ?>
                  ...
                  <div class="modal-header zmc-modal-header">
                    <div>
                      <div class="zmc-modal-title">
                        ...
                        Reassign Category
                        <span class="ms-2 text-muted" style="font-weight:800;font-size:12px;"><?php echo e($ref); ?></span>
                      </div>
            ...
            <div class="modal fade" id="approveModal<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <form class="modal-content" method="POST" action="<?php echo e($approveUrl($app->id)); ?>" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="modal-header zmc-modal-header">
                    <div>
                      <div class="zmc-modal-title">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <?php if($app->registrar_letter_path): ?>
                        <div class="small text-success mb-1"><i class="ri-check-line"></i> Letter already uploaded</div>
                      <?php endif; ?>
                      <input type="file" name="registrar_letter" class="form-control zmc-input" accept=".pdf,.jpg,.jpeg,.png" <?php echo e(empty($app->registrar_letter_path) ? 'required' : ''); ?>>
            ...
            <div class="modal fade" id="fixRequestModal<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <form class="modal-content" method="POST" action="<?php echo e(route('staff.registrar.applications.fix-request', $app)); ?>">
                  <?php echo csrf_field(); ?>
                  <div class="modal-header zmc-modal-header">
                    <div>
                      <div class="zmc-modal-title">
            ...
            <div class="modal fade" id="pushToAccountsModal<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <form class="modal-content" method="POST" action="<?php echo e(route('staff.registrar.applications.push-to-accounts', $app)); ?>">
                  <?php echo csrf_field(); ?>
                  <div class="modal-header zmc-modal-header">
                    <div>
                      <div class="zmc-modal-title">
