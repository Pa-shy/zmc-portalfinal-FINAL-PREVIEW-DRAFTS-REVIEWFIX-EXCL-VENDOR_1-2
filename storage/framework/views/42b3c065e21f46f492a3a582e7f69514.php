...
<head>
  ...
  <title>Print Card (Back) - <?php echo e($application->reference); ?></title>
  <style>
    <?php
    ...
    .header {
      ...
      border-bottom: 1px solid <?php echo e($primaryColor); ?>33;
    }
    ...
    .notice {
      ...
      border: 1px dashed <?php echo e($secondaryColor); ?>;
      border-radius: 4px;
    }
    ...
    .footer {
      ...
      color: <?php echo e($primaryColor); ?>;
      font-weight: 700;
      border-top: 1px solid <?php echo e($primaryColor); ?>33;
      padding-top: 4px;
    }
...
<body>
  <div class="card">
    ...
    <div class="content">
      <div class="header">
        <img src="<?php echo e(asset('zmc_logo.png')); ?>" class="logo" alt="ZMC">
      ...
      <div class="body-content">
        <div class="left-info">
          ...
          <div class="info-line"><b>Designation:</b> <?php echo e($payload['designation'] ?? 'Media Practitioner'); ?></div>
          <div class="info-line"><b>Accreditation No:</b> <?php echo e($payload['accreditation_number'] ?? ($payload['reg_no'] ?? ($payload['ref'] ?? '—'))); ?></div>
          <div class="info-line"><b>Valid:</b> <?php echo e($payload['valid_from'] ?? '—'); ?> to <?php echo e($payload['valid_to'] ?? '—'); ?></div>
      ...
      <div class="footer">
        ...
        <div><?php echo e($payload['ref'] ?? $application->reference); ?></div>
      </div>
    </div>
  </div>
  ...
  <script>
    (function(){
      const value = <?php echo json_encode($payload['qr_value'] ?? ($application->reference ?? ''), 15, 512) ?>;
      try {
...
<?php /**PATH /home/runner/workspace/resources/views/staff/production/card_print_back.blade.php ENDPATH**/ ?>