        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <form action="<?php echo e(route('admin.dashboard')); ?>" method="GET" id="yearFilterForm" class="me-2">
...
<script>
  (function () {
    async function refreshAdminStats() {
      try {
        const url = new URL("<?php echo e(route('admin.dashboard.stats')); ?>", window.location.origin);
        url.searchParams.append('year', "<?php echo e($year); ?>");
