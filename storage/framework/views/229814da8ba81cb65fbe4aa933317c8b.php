       ...
       <div class="form-row">
         <div class="form-field">
           ...
           <div class="d-flex gap-2">
             <?php if($user->profile_data['social']['twitter'] ?? false): ?>
               <span class="badge bg-light text-dark border"><i class="ri-twitter-x-line me-1"></i><?php echo e($user->profile_data['social']['twitter']); ?></span>
             <?php endif; ?>
             <?php if($user->profile_data['social']['facebook'] ?? false): ?>
               <span class="badge bg-light text-dark border"><i class="ri-facebook-box-line me-1"></i>Facebook</span>
             <?php endif; ?>
             <?php if($user->profile_data['social']['linkedin'] ?? false): ?>
               <span class="badge bg-light text-dark border"><i class="ri-linkedin-box-line me-1"></i>LinkedIn</span>
             <?php endif; ?>
             <?php if(!($user->profile_data['social'] ?? false)): ?>
