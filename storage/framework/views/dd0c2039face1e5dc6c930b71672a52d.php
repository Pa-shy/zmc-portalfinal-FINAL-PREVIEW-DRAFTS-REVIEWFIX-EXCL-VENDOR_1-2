            ...
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    <div class="p-4 rounded-4 bg-slate-50 border border-slate-100 text-center">
                        <h2 class="fw-bold text-slate-900 mb-1"><?php echo e(number_format($load[0], 2)); ?></h2>
                        <div class="small fw-bold text-slate-600 uppercase">CPU Load (1m)</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-4 rounded-4 bg-slate-50 border border-slate-100 text-center">
                        <h2 class="fw-bold text-slate-900 mb-1"><?php echo e(round($memory['usage'] / 1024 / 1024, 1)); ?> MB</h2>
...
<?php /**PATH /home/runner/workspace/resources/views/staff/it/dashboard/partials/performance.blade.php ENDPATH**/ ?>