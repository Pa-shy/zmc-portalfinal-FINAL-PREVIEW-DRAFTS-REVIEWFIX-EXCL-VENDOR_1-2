<?php $__env->startSection('title', 'Renewal / Replacement of Registration (AP5)'); ?>
              ...
              <tbody>
                <?php $__currentLoopData = $drafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td class="text-end">
                      <a class="btn btn-sm btn-primary" href="<?php echo e(route('mediahouse.renewals', ['draft' => $d->reference])); ?>">
...
<script>
  ...
  async function ap5DoLookup(){
    ...
    try {
      const url = "<?php echo e(url('/media-house/registration/lookup-number')); ?>/" + encodeURIComponent(num);
  ...
  async function submitAp5Registration(){
    ...
    try{
      const res = await fetch("<?php echo e(route('mediahouse.ap5.submit')); ?>", {
        method: "POST",
        headers: {
  ...
  async function saveDraftAp5Registration(){
    ...
    try{
      const res = await fetch('<?php echo e(route("mediahouse.ap5.saveDraft")); ?>', {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/portal/mediahouse/renewals.blade.php ENDPATH**/ ?>