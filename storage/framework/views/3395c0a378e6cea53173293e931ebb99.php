...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
    ...
    <div class="d-flex gap-2">
      ...
      <a href="<?php echo e(route('admin.roles.index')); ?>" class="btn btn-sm btn-outline-primary"><i class="ri-shield-keyhole-line me-1"></i> Roles</a>
    </div>
  </div>
  ...
  <div class="row g-4">
    <div class="col-12 col-xl-5">
      <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
          <form method="POST" action="<?php echo e(route('admin.permissions.store')); ?>" class="d-flex gap-2 flex-wrap">
            <?php echo csrf_field(); ?>
    ...
    <div class="col-12 col-xl-7">
      <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
          ...
          <span class="badge bg-dark"><?php echo e($permissions->count()); ?></span>
        </div>
          ...
          <table class="table zmc-table-lite mb-0">
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  <td class="fw-bold"><?php echo e(str_replace('_',' ', $p->name)); ?></td>
                </tr>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/admin/permissions/index.blade.php ENDPATH**/ ?>