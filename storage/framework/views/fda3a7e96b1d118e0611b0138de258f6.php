          ...
          <div class="card-body">
            <div class="d-flex align-items-center gap-3 mb-3">
              <div class="bg-light rounded-circle flex-shrink-0" style="width:48px;height:48px;display:flex;align-items:center;justify-content:center;">
                <i class="<?php echo e($it['icon']); ?>" style="font-size:24px; color: #2563eb;"></i>
              </div>
              <div>
                <div class="fw-bold h6 mb-0"><?php echo e($it['label']); ?></div>
                <div class="text-muted small"><?php echo e($it['description']); ?></div>
              </div>
            </div>

            <button type="button" class="btn btn-sm btn-dark w-100" data-bs-toggle="collapse" data-bs-target="#filter-<?php echo e($it['type']); ?>">
              <i class="ri-filter-3-line me-1"></i> Configure & Download
            </button>

            <div class="collapse mt-3" id="filter-<?php echo e($it['type']); ?>" data-bs-parent="#downloadAccordion">
              <form action="<?php echo e(route('admin.downloads.csv', $it['type'])); ?>" method="GET" class="p-3 bg-light rounded border">
                <div class="row g-2">
                  <div class="col-6">
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/admin/downloads/index.blade.php ENDPATH**/ ?>