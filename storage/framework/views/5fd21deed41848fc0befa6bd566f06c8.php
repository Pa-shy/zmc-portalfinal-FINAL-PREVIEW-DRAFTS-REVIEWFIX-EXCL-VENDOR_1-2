<?php $__env->startSection('title', 'Rejected Waivers'); ?>

<?php $__env->startSection('content'); ?>
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
    <div>
      <h4 class="fw-bold m-0" style="font-size:22px; color:#1e293b;">Rejected Waivers</h4>
      <div class="text-muted mt-1" style="font-size:13px;">Waivers rejected with reasons (useful for appeals and audit).</div>
    </div>
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <tr>
              ...
              <td class="text-muted small"><?php echo e($appeal ? 'Filed' : '—'); ?></td>
              <td class="text-end">
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/accounts/waivers_rejected.blade.php ENDPATH**/ ?>