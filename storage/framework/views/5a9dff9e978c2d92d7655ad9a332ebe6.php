<div class="zmc-card bg-white shadow-sm border-0 rounded-4 p-4 mb-4">
    <div class="row g-4 align-items-center">
        <div class="col-md-6 border-end">
            ...
            <div class="row text-center g-3">
                <div class="col-6">
                    <div class="p-3 bg-success-subtle rounded-4 h-100">
                        ...
                        <div class="h2 fw-black mb-0 text-success"><?php echo e(number_format($issuance['total_issued'] ?? 0)); ?></div>
                        <div class="smaller text-muted mt-1">This month</div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="p-3 <?php echo e(($issuance['unprinted_approvals'] ?? 0) > 0 ? 'bg-warning-subtle' : 'bg-light'); ?> rounded-4 h-100 border-start border-4 <?php echo e(($issuance['unprinted_approvals'] ?? 0) > 0 ? 'border-warning' : 'border-success'); ?>">
                        <div class="text-muted small fw-bold text-uppercase mb-1">Pending Print</div>
                        <div class="h2 fw-black mb-0 <?php echo e(($issuance['unprinted_approvals'] ?? 0) > 0 ? 'text-warning' : 'text-success'); ?>">
                            <?php echo e(number_format($issuance['unprinted_approvals'] ?? 0)); ?>

                        </div>
                        <div class="smaller text-muted mt-1">
                            <?php if(($issuance['unprinted_approvals'] ?? 0) > 0): ?>
                                Requires attention
                            <?php else: ?>
                                All printed
                            <?php endif; ?>
            ...
            <?php if(($issuance['unprinted_approvals'] ?? 0) > 10): ?>
                <div class="alert alert-warning border-0 rounded-4 mt-3 mb-0">
                    <div class="d-flex align-items-center gap-2">
                        <i class="ri-alert-line h5 mb-0"></i>
                        <div class="smaller">
                            <strong>Print Queue Alert:</strong> <?php echo e($issuance['unprinted_approvals']); ?> approved applications awaiting print
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="row text-center mt-3 g-2">
                    <div class="col-6">
                        <div class="p-2 bg-light rounded-3">
                            ...
                            <div class="h5 fw-black mb-0 text-success"><?php echo e(number_format($totalPrints)); ?></div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-2 bg-light rounded-3">
                            <div class="smaller text-muted">Reprints</div>
                            <div class="h5 fw-black mb-0 text-danger"><?php echo e(number_format($totalReprints)); ?></div>
                        </div>
                    </div>
                </div>
                
                <div class="mt-3 p-3 <?php echo e($reprintRate > 15 ? 'bg-danger-subtle' : ($reprintRate > 10 ? 'bg-warning-subtle' : 'bg-success-subtle')); ?> rounded-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="small fw-bold <?php echo e($reprintRate > 15 ? 'text-danger' : ($reprintRate > 10 ? 'text-warning' : 'text-success')); ?>">
                            Reprint Rate
                        </span>
                        <span class="h4 fw-black mb-0 <?php echo e($reprintRate > 15 ? 'text-danger' : ($reprintRate > 10 ? 'text-warning' : 'text-success')); ?>">
                            <?php echo e($reprintRate); ?>%
                        </span>
                    </div>
                    <div class="smaller text-muted mt-1">
                        <?php if($reprintRate > 15): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Issuance data:', <?php echo json_encode($issuance ?? [], 15, 512) ?>);
    ...
    <?php if($grandTotal > 0): ?>
        if (typeof ApexCharts !== 'undefined') {
            ...
            if (printWasteEl) {
                try {
                    const prints = <?php echo e($totalPrints); ?>;
                    const reprints = <?php echo e($totalReprints); ?>;
...
<?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/staff/director/partials/issuance.blade.php ENDPATH**/ ?>