    ...
    <div class="col-xl-8">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body p-4 pt-0">
                <form action="<?php echo e(route('staff.it.config.save')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="mb-4">
...
<?php /**PATH /home/runner/workspace/resources/views/staff/it/dashboard/partials/workflow.blade.php ENDPATH**/ ?>