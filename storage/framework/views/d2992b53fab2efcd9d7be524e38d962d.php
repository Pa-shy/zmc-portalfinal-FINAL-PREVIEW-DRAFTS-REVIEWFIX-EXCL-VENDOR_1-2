...
<div class="zmc-dashboard-wrapper" style="font-family: var(--font-primary); color: var(--zmc-text-dark);">
    ...
    <div class="row g-3 mb-4">
        ...
        <?php echo $__env->make('staff.director.partials.kpi-card', [
    ...
    <div class="zmc-card bg-white shadow-sm border-0 rounded-4 p-4 mb-4">
        ...
        <div class="row g-3">
            ...
            <?php echo $__env->make('staff.director.partials.risk-indicator', [
    ...
    <div class="zmc-card bg-white shadow-sm border-0 rounded-4 p-4 mb-4">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle" id="highRiskActivityTable">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $highRiskActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="small"><?php echo e(\Carbon\Carbon::parse($activity->created_at)->format('d M Y, H:i')); ?></td>
                        <td>
                            <span class="badge bg-<?php echo e($activity->action_type === 'category_reassignment' ? 'warning' : ($activity->action_type === 'manual_override' ? 'danger' : 'info')); ?> bg-opacity-10 text-<?php echo e($activity->action_type === 'category_reassignment' ? 'warning' : ($activity->action_type === 'manual_override' ? 'danger' : 'info')); ?>">
                                <?php echo e(ucwords(str_replace('_', ' ', $activity->action_type))); ?>

                            </span>
                        </td>
                        <td class="small fw-medium"><?php echo e($activity->staff_name ?? 'System'); ?></td>
                        <td class="small font-monospace"><?php echo e($activity->application_id ?? 'N/A'); ?></td>
                        <td class="small text-muted"><?php echo e(Str::limit($activity->details ?? 'No details', 50)); ?></td>
                        <td>
                            <span class="badge bg-<?php echo e($activity->risk_level === 'high' ? 'danger' : ($activity->risk_level === 'medium' ? 'warning' : 'info')); ?>">
                                <?php echo e(ucfirst($activity->risk_level ?? 'low')); ?>
...
function refreshKPIs() {
    fetch('<?php echo e(route("staff.director.dashboard")); ?>?ajax=1', {
        method: 'GET',
        headers: {
...
function refreshHighRiskActivity() {
    ...
    fetch('<?php echo e(route("staff.director.dashboard")); ?>?ajax=1&section=highRiskActivity', {
        method: 'GET',
        headers: {
            'X-Requested-With': 'XMLHttpRequest',
            'Accept': 'application/json'
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/director/dashboard.blade.php ENDPATH**/ ?>