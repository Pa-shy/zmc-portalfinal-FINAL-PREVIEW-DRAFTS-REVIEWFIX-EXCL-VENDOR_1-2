<?php $__env->startSection('title', 'PayNow & Fees Audit'); ?>
...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  ...
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
    <div>
      <h4 class="fw-bold m-0" style="font-size:22px; color:#1e293b;">PayNow & Fees Audit</h4>
    ...
    <div class="d-flex gap-2">
      <a class="btn btn-success btn-sm" href="<?php echo e(route('staff.auditor.paynow.csv', request()->query())); ?>">
  ...
  <div class="zmc-card shadow-sm border-0 p-3 mb-3">
    <form method="GET" class="row g-2 align-items-end">
      <div class="col-md-3">
        ...
        <input class="form-control form-control-sm" name="status" value="<?php echo e(request('status')); ?>" placeholder="e.g. paid, pending">
      </div>
      <div class="col-md-3">
      ...
      <div class="col-md-3 d-flex gap-2">
        ...
        <a class="btn btn-white border btn-sm" href="<?php echo e(route('staff.auditor.paynow')); ?>">Reset</a>
      </div>
    </form>
  </div>
      ...
      <table class="table table-hover align-middle mb-0">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <tr <?php if($dup || $missing): ?> style="background:#fff7ed;" <?php endif; ?>>
              ...
              <td class="small">
                <?php echo e($a->paynow_reference ?? '—'); ?>

                <?php if($dup): ?>
                  <div class="small" style="color:#dc2626;">Duplicate reference</div>
                <?php endif; ?>
              </td>
              <td class="small fw-bold"><?php echo e($a->payment_status ?? '—'); ?></td>
              <td class="small">
                <?php echo e($a->paynow_confirmed_at ? $a->paynow_confirmed_at->format('d M Y H:i') : '—'); ?>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/staff/auditor/paynow.blade.php ENDPATH**/ ?>