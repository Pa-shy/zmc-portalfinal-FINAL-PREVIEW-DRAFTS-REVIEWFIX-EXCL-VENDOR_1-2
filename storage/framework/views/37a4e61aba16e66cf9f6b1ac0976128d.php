<?php $__env->startSection('title', 'Registrar Reports'); ?>
    ...
    <form action="<?php echo e(url()->current()); ?>" method="GET" class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="<?php echo e(url()->current()); ?>" class="btn btn-light border w-100">Reset</a>
                </div>
            </div>
        </div>
    </form>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center py-4">
                ...
                <div class="h2 fw-bold text-success mb-0"><?php echo e($approvals); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center py-4">
                <div class="text-muted small fw-bold text-uppercase">Reassignments</div>
                <div class="h2 fw-bold text-warning mb-0"><?php echo e($reassignments); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center py-4">
                <div class="text-muted small fw-bold text-uppercase">Total Prints</div>
                <div class="h2 fw-bold text-primary mb-0"><?php echo e($totalPrints); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm text-center py-4">
                <div class="text-muted small fw-bold text-uppercase">Cert Edits</div>
                <div class="h2 fw-bold text-info mb-0"><?php echo e($edits); ?></div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/registrar/reports.blade.php ENDPATH**/ ?>