<?php $__env->startSection('title', 'Certificate Preview'); ?>
  ...
  <div class="row g-3">
    <div class="col-12 col-lg-8 mx-auto">
      ...
      <div class="zmc-card mb-4">
        ...
        <form method="POST" action="<?php echo e(route('staff.production.applications.certificate.print', $application)); ?>" target="_blank">
          <?php echo csrf_field(); ?>

          <div class="row g-3 mb-4">
            <div class="col-md-12">
                <label class="form-label small fw-bold text-muted">Organization / Recipient Name</label>
                <input type="text" name="certificate_payload[org_name]" class="form-control zmc-input" value="<?php echo e($payload['org_name']); ?>" oninput="updateContent('org_name', this.value)">
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-bold text-muted">Category</label>
                <input type="text" name="certificate_payload[category]" class="form-control zmc-input" value="<?php echo e($payload['category']); ?>" oninput="updateContent('category', this.value)">
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-bold text-muted">Registration / Certificate No</label>
                <input type="text" name="certificate_payload[reg_no]" class="form-control zmc-input" value="<?php echo e($payload['certificate_no']); ?>" oninput="updateContent('reg_no', this.value)">
            </div>
            <div class="col-md-12">
                <label class="form-label small fw-bold text-muted">Certification Statement</label>
                <textarea name="certificate_payload[certification_statement]" class="form-control zmc-input" rows="2" oninput="updateContent('certification_statement', this.value)"><?php echo e($payload['certification_statement']); ?></textarea>
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-bold text-muted">Issue Date</label>
                <input type="date" name="certificate_payload[issue_date]" class="form-control zmc-input" value="<?php echo e($payload['valid_from']); ?>" oninput="updateContent('issue_date', this.value)">
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-bold text-muted">Valid Until</label>
                <input type="date" name="certificate_payload[valid_until]" class="form-control zmc-input" value="<?php echo e($payload['valid_until']); ?>" oninput="updateContent('valid_until', this.value)">
            </div>

            <div class="col-md-12">
                <label class="form-label small fw-bold text-muted">Signatory Title (CEO)</label>
                <input type="text" name="certificate_payload[left_sign_title]" class="form-control zmc-input" value="<?php echo e($payload['left_sign_title']); ?>" oninput="updateContent('left_sign_title', this.value)">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="certificate_payload[top_heading]" class="form-control zmc-input" value="<?php echo e($payload['top_heading']); ?>" oninput="updateContent('top_heading', this.value)">
            </div>
            <div class="col-md-6">
                <label class="form-label small fw-bold text-muted">Certificate Main Title</label>
                <input type="text" name="certificate_payload[certificate_title]" class="form-control zmc-input" value="<?php echo e($payload['certificate_title']); ?>" oninput="updateContent('certificate_title', this.value)">
            </div>
            <div class="col-md-12">
                <label class="form-label small fw-bold text-muted">Certificate Subtitle</label>
                <input type="text" name="certificate_payload[certificate_sub]" class="form-control zmc-input" value="<?php echo e($payload['certificate_sub']); ?>" oninput="updateContent('certificate_sub', this.value)">
            </div>
          </div>
      ...
      <div class="cert-paper" id="certPreview">
        <div class="cert-inner">
          ...
          <img src="<?php echo e(asset('zmc_logo.png')); ?>" class="cert-watermark">

          
          <div class="cert-header">
            <img src="<?php echo e(asset('zmc_logo.png')); ?>" class="cert-header-logo" alt="ZMC Logo">
          ...
          <div class="cert-title" id="view_certificate_title"><?php echo e($payload['certificate_title']); ?></div>
          <div class="cert-subtitle" id="view_certificate_sub"><?php echo e($payload['certificate_sub']); ?></div>

          
          <div class="cert-number">
            Certificate No:
            <span id="view_reg_no"><?php echo e($payload['certificate_no']); ?></span>
          </div>

          
          <div class="cert-section">
            <div class="cert-label">Issued To</div>
            <div class="cert-value cert-strong" id="view_org_name"><?php echo e($payload['org_name']); ?></div>
          </div>

          
          <div class="cert-section">
            <div class="cert-label">Category</div>
            <div class="cert-value" id="view_category"><?php echo e($payload['category']); ?></div>
          </div>

          
          <div class="cert-statement" id="view_certification_statement">
            <?php echo e($payload['certification_statement']); ?>

          </div>

          
          <div class="cert-validity">
            <div><strong>Valid From:</strong> <span id="view_issue_date"><?php echo e($payload['valid_from']); ?></span></div>
            <div><strong>To:</strong> <span id="view_valid_until"><?php echo e($payload['valid_until']); ?></span></div>
          </div>
          ...
          <div class="cert-footer">
            <div class="cert-sign-block">
              ...
              <div class="cert-sign-title" id="view_left_sign_title"><?php echo e($payload['left_sign_title']); ?></div>
              <div class="cert-sign-date"><?php echo e($payload['left_sign_date']); ?></div>
            </div>
            <a id="certPreviewQrLink" href="<?php echo e($payload['qr_value']); ?>" target="_blank" rel="noopener" class="cert-qr" title="Open verification page">
...
<script>
  ...
  new QRCode(document.getElementById("certPreviewQr"), {
    text: "<?php echo e($payload['qr_value']); ?>",
    width: 96,
    height: 96
  });
</script>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/production/certificate_preview.blade.php ENDPATH**/ ?>