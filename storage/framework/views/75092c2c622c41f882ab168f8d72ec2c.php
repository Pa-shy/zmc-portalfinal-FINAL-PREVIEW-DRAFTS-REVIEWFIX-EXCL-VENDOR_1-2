                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                  <form class="modal-content" method="POST" action="<?php echo e(route('staff.accounts.waivers.approve', $app->id)); ?>">
                    ...
                    <div class="modal-header zmc-modal-header">
                      <div>
                        <div class="zmc-modal-title"><i class="ri-check-line me-2" style="color:var(--zmc-accent)"></i> Approve waiver <span class="ms-2 text-muted" style="font-weight:800;font-size:12px;"><?php echo e($ref); ?></span></div>
              ...
              <div class="modal fade" id="rejectWaiver<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                  <form class="modal-content" method="POST" action="<?php echo e(route('staff.accounts.waivers.reject', $app->id)); ?>">
                    ...
                    <div class="modal-header zmc-modal-header">
                      <div>
                        <div class="zmc-modal-title"><i class="ri-close-line me-2" style="color:#dc2626"></i> Reject waiver <span class="ms-2 text-muted" style="font-weight:800;font-size:12px;"><?php echo e($ref); ?></span></div>
