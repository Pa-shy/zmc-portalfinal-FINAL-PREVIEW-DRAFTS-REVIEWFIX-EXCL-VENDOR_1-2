                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-4">
                                    <div class="fw-bold text-slate-900 small"><?php echo e($session->ip_address); ?></div>
                                    <div class="text-slate-600 fw-bold" style="font-size: 10px;">ID: <?php echo e(substr($session->id, 0, 8)); ?>...</div>
                                </td>
                                <td>
                                    <div class="text-slate-600 small text-truncate" style="max-width: 300px;"><?php echo e($session->user_agent); ?></div>
                                </td>
                                <td>
                                    <span class="small"><?php echo e(Carbon\Carbon::createFromTimestamp($session->last_activity)->diffForHumans()); ?></span>
                                </td>
                                <td class="text-end pe-4">
                                    <form action="<?php echo e(route('staff.it.security.session.logout', $session->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
    ...
    <div class="col-xl-4">
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 bg-dark text-white">
             ...
             <div class="d-grid gap-2">
                 <form action="<?php echo e(route('staff.it.security.ip.block')); ?>" method="POST" class="d-grid">
                     <?php echo csrf_field(); ?>
                     <button type="submit" class="btn btn-white-10 text-white btn-sm border-0 py-2 rounded-pill fw-bold">Manual IP Block</button>
                 </form>
                 <form action="<?php echo e(route('staff.it.security.toggle_rate_limiting')); ?>" method="POST" class="d-grid">
                     <?php echo csrf_field(); ?>
                 ...
                 <form action="<?php echo e(route('staff.it.security.ssl_audit')); ?>" method="POST" class="d-grid">
                     <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/staff/it/dashboard/partials/security.blade.php ENDPATH**/ ?>