                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $application->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a href="<?php echo e($doc->url); ?>" target="_blank" class="btn btn-xs btn-outline-primary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <?php if($application->status === 'forwarded_to_registrar_no_approval'): ?>
                        <div class="alert" style="background: rgba(250, 204, 21, 0.1); border: 2px solid #facc15; color: #000;">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <?php if($application->forward_no_approval_reason): ?>
                                        <div class="p-2 rounded mb-2" style="background: #fff; border: 1px solid #facc15;">
                                            <strong style="color: #000;">Officer's Reason:</strong>
                                            <div class="mt-1" style="color: #334155;"><?php echo e($application->forward_no_approval_reason); ?></div>
                                        </div>
                                    <?php endif; ?>
                                    <small class="text-muted">
                                        <i class="ri-user-line me-1"></i>
                                        Forwarded by: <?php echo e($application->assignedOfficer?->name ?? 'Officer'); ?> on <?php echo e($application->last_action_at?->format('d M Y H:i')); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('staff.registrar.applications.approve-special-case', $application)); ?>" class="mb-3">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php if($application->status === 'verified_by_officer_pending_registrar' && $application->application_type === 'registration'): ?>
                        <div class="alert" style="background: rgba(250, 204, 21, 0.1); border: 2px solid #facc15; color: #000;">
                            <div class="d-flex align-items-start">
                        ...
                        <form method="POST" action="<?php echo e(route('staff.registrar.applications.approve-with-letter', $application)); ?>" enctype="multipart/form-data" class="mb-3">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category_code" class="form-select" required>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Application::massMediaCategories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($code); ?>" <?php echo e(($application->media_house_category_code ?? '') == $code ? 'selected' : ''); ?>>
...
<div class="modal fade" id="fixRequestModal" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content" method="POST" action="<?php echo e(route('staff.registrar.applications.send-fix-request', $application)); ?>">
            <?php echo csrf_field(); ?>
