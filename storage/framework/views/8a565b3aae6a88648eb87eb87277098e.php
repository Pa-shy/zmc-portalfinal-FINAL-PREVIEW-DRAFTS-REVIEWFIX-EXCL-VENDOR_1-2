...
(function(){
  ...
  async function send(msg){
    ...
    try{
      const res = await fetch('<?php echo e(route("chatbot.message")); ?>', {
        method:'POST',
        headers:{
...
<?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/layouts/chatbot.blade.php ENDPATH**/ ?>