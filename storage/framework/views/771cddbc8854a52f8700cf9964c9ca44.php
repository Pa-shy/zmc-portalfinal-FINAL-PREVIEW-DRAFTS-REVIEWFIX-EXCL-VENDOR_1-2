...
<head>
  ...
  <title>Print Certificate - <?php echo e($application->reference); ?></title>
  <style>
    @page { size: A4 <?php echo e($orientation ?? 'portrait'); ?>; margin: 12mm; }
    body {
    ...
    .certificate {
      width: 100%;
      max-width: <?php echo e(($orientation ?? 'portrait') === 'landscape' ? '1000px' : '700px'); ?>;
      margin: 0 auto;
      padding: 30px 40px;
      position: relative;
...
<body>
  <div class="certificate">
    ...
    <div class="content">
      <div class="header">
        <img src="<?php echo e(asset('zmc_logo.png')); ?>" class="header-logo-img" alt="ZMC Logo">
        <div class="org-name">
      ...
      <div class="details-box">
        <div class="detail-row">
          ...
          <span class="detail-value"><?php echo e($payload['category'] ?? '—'); ?></span>
        </div>
        <div class="detail-row">
          <span class="detail-label">Registration No:</span>
          <span class="detail-value"><?php echo e($payload['reg_no'] ?? '—'); ?></span>
        </div>
      </div>
      ...
      <div class="validity-section">
        <div class="validity-item">
          ...
          <div class="validity-value"><?php echo e($payload['issue_date'] ?? '—'); ?></div>
        </div>
        <div class="validity-item">
          <div class="validity-label">To</div>
          <div class="validity-value"><?php echo e($payload['valid_until'] ?? '—'); ?></div>
        </div>
      </div>
      ...
      <div class="footer">
        <div class="signature-block">
          ...
          <div class="signature-title"><?php echo e($payload['left_sign_title'] ?? 'Chief Executive Officer'); ?></div>
          <div class="signature-date">DATE: <?php echo e($payload['issue_date'] ?? '................'); ?></div>
        </div>
...
<?php /**PATH /home/runner/workspace/resources/views/staff/production/certificate_print.blade.php ENDPATH**/ ?>