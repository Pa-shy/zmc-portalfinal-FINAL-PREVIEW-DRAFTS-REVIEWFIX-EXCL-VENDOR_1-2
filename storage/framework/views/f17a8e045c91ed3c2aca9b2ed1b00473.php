<?php $__env->startSection('title', 'How to Get Registered'); ?>
<?php $__env->startSection('page_title', 'HOW TO GET REGISTERED'); ?>
...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  ...
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
    ...
    <div class="d-flex gap-2">
      <a href="<?php echo e(route('mediahouse.requirements')); ?>" class="btn btn-outline-dark btn-sm px-3">
  ...
  <div class="row g-3 mb-4">
    <div class="col-12 col-lg-6">
      <div class="zmc-card h-100">
        ...
        <div class="mt-3">
          <a href="<?php echo e(route('mediahouse.requirements')); ?>" class="btn btn-sm btn-outline-dark">
  ...
  <div class="text-center">
    <a href="<?php echo e(route('mediahouse.new')); ?>" class="btn btn-lg px-5 py-3" style="background:#2e7d32;color:#fff;border-radius:12px;font-weight:900;">
