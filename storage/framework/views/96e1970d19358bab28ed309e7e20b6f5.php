        ...
        <div class="row g-2 mb-3">
          <div class="col-6">
            <div class="border rounded p-2 text-center">
              <div class="h4 fw-bold mb-0"><?php echo e($kpis['media_practitioners_total'] ?? 0); ?></div>
              <div class="small text-muted">Total</div>
            </div>
          </div>
          <div class="col-6">
            <div class="border rounded p-2 text-center">
              <div class="h4 fw-bold mb-0 text-success"><?php echo e($kpis['media_practitioners_accredited'] ?? 0); ?></div>
    ...
    <div class="col-12 col-md-6">
      <div class="zmc-card h-100">
        ...
        <div class="row g-2 mb-3">
          <div class="col-6">
            <div class="border rounded p-2 text-center">
              <div class="h4 fw-bold mb-0"><?php echo e($kpis['media_houses_total'] ?? 0); ?></div>
              <div class="small text-muted">Total</div>
            </div>
          </div>
          <div class="col-6">
            <div class="border rounded p-2 text-center">
              <div class="h4 fw-bold mb-0 text-success"><?php echo e($kpis['media_houses_registered'] ?? 0); ?></div>
      ...
      <table class="table table-hover align-middle mb-0 zmc-mini-table">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <tr>
            ...
            <td class="small"><?php echo e(!empty($app->created_at) ? \Carbon\Carbon::parse($app->created_at)->format('d M Y H:i') : '—'); ?></td>
            <td>
                ...
                <form class="modal-content" method="POST" action="<?php echo e($correctionUrl($app->id)); ?>">
                  ...
                  <div class="modal-header zmc-modal-header">
                    <div class="d-flex align-items-center gap-2">
                      ...
                      <div>
                        <div class="zmc-modal-title">Request correction <span class="ms-2 text-muted" style="font-weight:800;font-size: var(--font-size-sm);"><?php echo e($ref); ?></span></div>
            ...
            <div class="modal fade" id="approveModal<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <form class="modal-content" method="POST" action="<?php echo e($approveUrl($app->id)); ?>">
                  ...
                  <div class="modal-header zmc-modal-header">
                    <div>
                      <div class="zmc-modal-title"><i class="fa-solid fa-check me-2" style="color:var(--zmc-accent-dark)"></i>Approve application <span class="ms-2 text-muted" style="font-weight:800;font-size: var(--font-size-sm);"><?php echo e($ref); ?></span></div>
