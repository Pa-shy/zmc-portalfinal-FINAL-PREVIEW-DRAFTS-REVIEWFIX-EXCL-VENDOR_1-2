    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium"><?php echo e($renewal->getPaymentMethodLabel()); ?></p>
                    </div>
                    <?php if($renewal->payment_reference): ?>
                        <div>
                            <p class="text-sm text-gray-600">Reference</p>
                            <p class="font-medium"><?php echo e($renewal->payment_reference); ?></p>
                        </div>
                    <?php endif; ?>
                    <?php if($renewal->payment_amount): ?>
                        <div>
                            <p class="text-sm text-gray-600">Amount</p>
                            <p class="font-medium">$<?php echo e(number_format($renewal->payment_amount, 2)); ?></p>
                        </div>
                    <?php endif; ?>
                    <?php if($renewal->payment_date): ?>
                        <div>
                            <p class="text-sm text-gray-600">Payment Date</p>
                            <p class="font-medium"><?php echo e($renewal->payment_date->format('M d, Y')); ?></p>
                        </div>
                    <?php endif; ?>
                    <div>
                        <p class="text-sm text-gray-600">Submitted</p>
                        <p class="font-medium"><?php echo e($renewal->payment_submitted_at->format('M d, Y H:i')); ?></p>
                    </div>
                </div>

                <?php if($renewal->payment_proof_path): ?>
                    <div class="mt-4">
                        <a href="<?php echo e(Storage::url($renewal->payment_proof_path)); ?>" 
                           target="_blank"
                            ...
                            <div class="border rounded-lg p-4">
                                ...
                                <div class="grid grid-cols-2 gap-4 mt-2 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p><?php echo e($change->new_value); ?></p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form method="POST" action="<?php echo e(route('staff.accounts.renewals.verify', $renewal)); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/accounts/renewal_show.blade.php ENDPATH**/ ?>