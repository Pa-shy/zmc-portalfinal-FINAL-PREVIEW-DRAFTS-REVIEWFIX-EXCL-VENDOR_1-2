    ...
    <div class="row g-4 align-items-center">
        <div class="col-md-8 border-end">
            ...
            <div id="revenueTrendChart" style="min-height: 350px;">
                <?php if(!isset($revenueTrend) || $revenueTrend->isEmpty()): ?>
        ...
        <div class="col-md-4">
            ...
            <div class="px-3">
                <div class="d-flex justify-content-between align-items-center mb-3 p-3 bg-light rounded-4">
                    ...
                    <span class="h5 fw-black mb-0 text-success"><?php echo e(number_format($aging['0_30'] ?? 0)); ?></span>
                </div>
                <div class="d-flex justify-content-between align-items-center mb-3 p-3 bg-light rounded-4 border-start border-4 border-warning">
                    ...
                    <span class="h5 fw-black mb-0 text-warning"><?php echo e(number_format($aging['30_60'] ?? 0)); ?></span>
                </div>
                <div class="d-flex justify-content-between align-items-center p-3 bg-light rounded-4 border-start border-4 border-danger">
                    ...
                    <span class="h5 fw-black mb-0 text-danger"><?php echo e(number_format($aging['60_plus'] ?? 0)); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="zmc-card bg-white shadow-sm border-0 rounded-4 p-4 h-100">
            ...
            <div id="revenueServiceChart" style="min-height: 250px;">
                <?php if(!isset($breakdown['service']) || $breakdown['service']->isEmpty()): ?>
                    <div class="d-flex align-items-center justify-content-center h-100 text-muted">
                        <div class="text-center">
        ...
        <div class="zmc-card bg-white shadow-sm border-0 rounded-4 p-4 h-100">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="text-center flex-grow-1 border-end">
                    ...
                    <div class="h2 fw-black mb-0"><?php echo e(number_format($waivers['count'] ?? 0)); ?></div>
                </div>
                <div class="text-center flex-grow-1">
                    <div class="text-muted small fw-bold text-uppercase">Total Prov. Value</div>
                    <div class="h2 fw-black mb-1 text-info">$<?php echo e(number_format($waivers['total_value'] ?? 0)); ?></div>
            ...
            <div class="mt-4">
                ...
                <?php if(isset($waivers['by_approver']) && $waivers['by_approver']->isNotEmpty()): ?>
                    <?php $__currentLoopData = $waivers['by_approver']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $approver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2 mt-1">
                            <span class="smaller fw-bold">User #<?php echo e($approver->waiver_approved_by); ?></span>
                            <span class="badge bg-primary rounded-pill"><?php echo e($approver->waiver_count); ?></span>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (revenueTrendEl) {
        try {
            const revenueData = <?php echo json_encode($revenueTrend ?? collect([]), 15, 512) ?>;
    ...
    if (revenueServiceEl) {
        try {
            const serviceData = <?php echo json_encode($breakdown['service'] ?? collect([]), 15, 512) ?>;
...
<?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/staff/director/partials/financial.blade.php ENDPATH**/ ?>