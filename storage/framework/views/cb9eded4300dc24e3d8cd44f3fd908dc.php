...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
    ...
    <a href="<?php echo e(route('mediahouse.portal')); ?>" class="btn btn-sm btn-outline-dark"><i class="ri-arrow-left-line me-1"></i> Back</a>
  </div>
              ...
              <form method="POST" action="<?php echo e(route('settings.profile')); ?>" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="profile[organization_name]" class="form-control" value="<?php echo e(old('profile.organization_name', Auth::user()->profile_data['organization_name'] ?? Auth::user()->name)); ?>" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="profile[head_office_address]" class="form-control" value="<?php echo e(old('profile.head_office_address', Auth::user()->profile_data['head_office_address'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Type of Mass Media Activities</label>
                        <input name="profile[mass_media_activities]" class="form-control" value="<?php echo e(old('profile.mass_media_activities', Auth::user()->profile_data['mass_media_activities'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Website</label>
                        <input name="profile[website]" type="url" class="form-control" value="<?php echo e(old('profile.website', Auth::user()->profile_data['website'] ?? '')); ?>" placeholder="https://">
                    </div>
                    <div class="col-md-12">
