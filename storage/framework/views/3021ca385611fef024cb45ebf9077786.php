<?php $__env->startSection('title', 'Staff Management - Media House Portal'); ?>
      ...
      <table class="table table-hover align-middle mb-0 zmc-mini-table">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td class="fw-bold text-dark"><?php echo e($member->journalist->name); ?></td>
              <td><?php echo e($member->journalist->email); ?></td>
              <td><?php echo e($member->role ?? '—'); ?></td>
              <td class="small text-muted"><?php echo e($member->created_at->format('d M Y')); ?></td>
              <td class="text-end">
                <form action="<?php echo e(route('mediahouse.staff.unlink', $member)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to unlink this media practitioner?')">
                  <?php echo csrf_field(); ?>
...
<div class="modal fade zmc-modal-pop" id="linkStaffModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form action="<?php echo e(route('mediahouse.staff.link')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/portal/mediahouse/staff/index.blade.php ENDPATH**/ ?>