        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0 zmc-mini-table">
            ...
            <?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="fw-bold"><?php echo e($n->title); ?></td>
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0 zmc-mini-table">
            ...
            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td class="fw-bold"><?php echo e($e->title); ?></td>
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-md-6"><label class="form-label zmc-lbl">Portal</label>
            <select class="form-select zmc-input" name="target_portal" required>
              ...
              <option value="journalist" <?php if($n->target_portal==='journalist'): echo 'selected'; endif; ?>>Journalist</option>
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-md-6"><label class="form-label zmc-lbl">Portal</label>
            <select class="form-select zmc-input" name="target_portal" required>
              ...
              <option value="journalist" <?php if($e->target_portal==='journalist'): echo 'selected'; endif; ?>>Journalist</option>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/admin/content/index.blade.php ENDPATH**/ ?>