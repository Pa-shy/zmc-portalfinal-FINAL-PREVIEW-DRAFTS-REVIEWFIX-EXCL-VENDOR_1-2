    ...
    <div class="form-steps-container">
      ...
      <div class="form-row">
         <div class="form-field">
           ...
           <input type="text" class="form-control" value="<?php echo e(Auth::user()->profile_data['national_id'] ?? 'Not Provided'); ?>" readonly>
         </div>
         <div class="form-field">
           <label class="form-label">Passport Number</label>
           <input type="text" class="form-control" value="<?php echo e(Auth::user()->profile_data['passport_number'] ?? 'Not Provided'); ?>" readonly>
         </div>
       </div>
       ...
       <div class="form-row">
         ...
         <div class="form-field">
           ...
           <input type="text" class="form-control" value="<?php echo e(Auth::user()->profile_data['secondary_phone'] ?? 'Not Provided'); ?>" readonly>
         </div>
       </div>
       ...
       <div class="form-row">
          ...
          <div class="form-field">
            ...
            <input type="text" class="form-control" value="<?php echo e(Auth::user()->profile_data['nationality'] ?? 'Not Provided'); ?>" readonly>
          </div>
       </div>
    </div>
  </div>
