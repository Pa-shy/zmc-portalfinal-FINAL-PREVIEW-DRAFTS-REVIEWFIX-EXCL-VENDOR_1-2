<?php $__env->startSection('title', 'IT Administration Dashboard'); ?>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-0 fw-bold"><?php echo e($stats['total_users'] ?? 0); ?></h3>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-0 fw-bold"><?php echo e($stats['staff_users'] ?? 0); ?></h3>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-0 fw-bold"><?php echo e($stats['new_users_today'] ?? 0); ?></h3>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h3 class="mb-0 fw-bold"><?php echo e($stats['audit_entries'] ?? 0); ?></h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php $__currentLoopData = $user->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge bg-primary bg-opacity-10 text-primary"><?php echo e($role->name); ?></span>
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item px-0">
                            <div class="d-flex justify-content-between">
                                ...
                                <small class="text-muted"><?php echo e($notice->created_at->diffForHumans()); ?></small>
                            </div>
                            <small class="text-muted"><?php echo e(Str::limit($notice->content, 50)); ?></small>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item">
                            <div class="d-flex justify-content-between">
                                <span class="badge bg-<?php echo e($log->action === 'approve' ? 'success' : ($log->action === 'reject' ? 'danger' : 'info')); ?>">
                                    <?php echo e(ucfirst($log->action)); ?>

                                </span>
                                <small class="text-muted"><?php echo e($log->created_at->diffForHumans()); ?></small>
                            </div>
                            <small class="d-block mt-1"><?php echo e(Str::limit($log->description, 60)); ?></small>
                            <small class="text-muted">by <?php echo e($log->user_name); ?></small>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <div class="border rounded p-3 h-100">
                                <span class="badge bg-<?php echo e($role['color']); ?> mb-2"><?php echo e($role['name']); ?></span>
                                <p class="mb-0 small text-muted"><?php echo e($role['desc']); ?></p>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/admin/dashboard.blade.php ENDPATH**/ ?>