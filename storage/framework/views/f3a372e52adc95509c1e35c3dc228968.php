...
<?php $__env->startSection('page_title', 'Notices & Events'); ?>
      ...
      <div class="zmc-card">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $notices ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="border-bottom pb-3 mb-3">
            <div class="fw-bold text-dark" style="text-transform: none;"><?php echo e($n->title); ?></div>
    ...
    <div class="col-12 col-lg-5">
      <div class="zmc-card">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $events ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="border-bottom pb-3 mb-3">
            <div class="fw-bold text-dark" style="text-transform: none;"><?php echo e($e->title); ?></div>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/portal/accreditation/notices.blade.php ENDPATH**/ ?>