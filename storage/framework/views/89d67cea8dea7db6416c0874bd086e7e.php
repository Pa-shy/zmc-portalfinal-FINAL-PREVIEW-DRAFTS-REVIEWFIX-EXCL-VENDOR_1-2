...
<div class="wrap">
  ...
  <div class="card">
    ...
    <form method="POST" action="<?php echo e(route('staff.choose_role')); ?>">
      <?php echo csrf_field(); ?>
      <div class="field">
        ...
        <select name="role" id="role" class="select" required>
          ...
          <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($role['key']); ?>" data-desc="<?php echo e($role['desc']); ?>"><?php echo e($role['title']); ?></option>
...
<?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/staff/select-role.blade.php ENDPATH**/ ?>