<?php $__env->startSection('title', 'Media Practitioner Portal Dashboard'); ?>
...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  ...
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <a href="<?php echo e(route('accreditation.renewals.index')); ?>" class="btn btn-white border shadow-sm btn-sm px-3">
        ...
        <div class="small text-muted">
          <?php $__empty_1 = true; $__currentLoopData = ($notices ?? collect())->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="d-flex gap-2 mb-2">
              ...
              <div>
                <div class="fw-bold" style="font-size:14px; text-transform: none !important;"><?php echo e($n->title); ?></div>
                <div class="text-muted" style="font-size:12px; text-transform: none !important;"><?php echo e(Str::limit(strip_tags($n->body), 90)); ?></div>
              </div>
            </div>
        ...
        <div class="small text-muted">
          <?php $__empty_1 = true; $__currentLoopData = ($events ?? collect())->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="d-flex justify-content-between align-items-start mb-2">
              <div>
                <div class="fw-bold" style="font-size:14px"><?php echo e($e->title); ?></div>
            ...
            <tr>
              ...
              <td class="text-end">
                <div class="zmc-action-strip">
                  <?php if($app->is_draft): ?>
                    <a class="btn btn-sm zmc-icon-btn btn-outline-secondary" href="<?php echo e(route('accreditation.new')); ?>" title="Continue">
                  ...
                  <?php else: ?>
                    ...
                    <?php if($status === 'correction_requested'): ?>
                      <a href="<?php echo e(route('accreditation.applications.edit', $app)); ?>" class="btn btn-sm btn-warning fw-bold" title="Edit & Resubmit">
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/portal/accreditation/dashboard.blade.php ENDPATH**/ ?>