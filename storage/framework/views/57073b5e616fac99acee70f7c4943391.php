...
<div id="mediahouse-renewal-confirm">
  ...
  <div class="form-container">
    <div class="form-header">
      ...
      <p>Review your registration information and indicate if any changes are needed</p>
    </div>
    ...
    <div class="form-steps-container">
      ...
      <div class="step-content active" id="confirmSection">
        <h3 class="step-title">Current Registration Information</h3>
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-6">
            <form method="POST" action="<?php echo e(route('mediahouse.renewals.confirm-no-changes', $renewal)); ?>">
              <?php echo csrf_field(); ?>
      ...
      <div class="step-content" id="changesFormContainer" style="display:none;">
        ...
        <form method="POST" action="<?php echo e(route('mediahouse.renewals.submit-changes', $renewal)); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/portal/mediahouse/renewals/confirm.blade.php ENDPATH**/ ?>