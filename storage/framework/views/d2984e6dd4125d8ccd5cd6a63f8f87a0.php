<?php $__env->startSection('title', 'Renewal / Replacement (AP5)'); ?>
<?php $__env->startSection('page_title', 'RENEWAL / REPLACEMENT (AP5)'); ?>
...
<div id="renewal-page">
  ...
  <?php if(isset($drafts) && $drafts->count()): ?>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-sm align-middle mb-0">
            ...
            <tbody>
              <?php $__currentLoopData = $drafts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td class="fw-semibold"><?php echo e($d->reference); ?></td>
                  <td class="text-capitalize"><?php echo e($d->request_type); ?></td>
                  <td class="text-muted"><?php echo e($d->created_at?->format('Y-m-d H:i')); ?></td>
                  <td class="text-end">
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('accreditation.renewals', ['draft' => $d->reference])); ?>">
  ...
  <div class="form-container">
    ...
    <div class="form-steps-container">
      ...
      <form id="ap5Form" onsubmit="return false;" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="draft_reference" value="<?php echo e($draft->reference ?? ''); ?>">
        <input type="hidden" name="current_step" id="ap5_current_step" value="<?php echo e(data_get($draft, 'form_data.current_step', 1)); ?>">
        ...
        <div class="step-content" id="ap5-step-2">
          ...
          <div class="current-step-info">
            <i class="ri-information-line me-2"></i>
            Enter your previous accreditation number to retrieve your record.
          </div>
        ...
        <div class="step-content" id="ap5-step-4">
          ...
          <div class="current-step-info"><i class="ri-information-line me-2"></i>Choose a payment method and confirm submission.</div>
...
<script>
  ...
  async function ap5DoLookup(){
    ...
    try {
      const url = "<?php echo e(url('/portal/accreditation/lookup-number')); ?>/" + encodeURIComponent(num);
      ...
      const fields = [
        ...
        ['ID / Passport', data.record.id_or_passport],
  ...
  async function submitAp5(){
    ...
    try{
      const res = await fetch('<?php echo e(route("accreditation.submitAp5")); ?>', {
        method: 'POST',
        headers: {
  ...
  async function saveDraftAp5(){
    ...
    try{
      const res = await fetch('<?php echo e(route('accreditation.renewals.saveDraft')); ?>', {
        method: 'POST',
        headers: {
          'X-CSRF-TOKEN': document.querySelector('input[name="_token"]')?.value || '<?php echo e(csrf_token()); ?>',
          'Accept': 'application/json'
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/portal/accreditation/renewals.blade.php ENDPATH**/ ?>