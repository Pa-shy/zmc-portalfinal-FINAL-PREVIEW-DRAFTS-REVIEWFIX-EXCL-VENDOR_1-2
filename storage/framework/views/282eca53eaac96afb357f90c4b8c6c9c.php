...
<div class="verify-card">
    ...
    <?php else: ?>
        ...
        <h5 class="fw-bold mb-0">
            <?php echo e($isAccreditation ? ($record->holder->name ?? 'Media Practitioner') : ($record->entity_name ?? 'Media House')); ?>

        </h5>
        <p class="text-muted small"><?php echo e($isAccreditation ? 'Accredited Media Practitioner' : 'Registered Media House'); ?></p>
