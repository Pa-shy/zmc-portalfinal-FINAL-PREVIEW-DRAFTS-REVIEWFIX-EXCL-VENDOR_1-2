...
<div class="zmc-dashboard-wrapper" style="font-family: var(--font-primary); color: var(--zmc-text-dark);">
  ...
  <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-4">
    ...
    <div class="d-flex align-items-center gap-2">
      <form action="<?php echo e(route('staff.production.dashboard')); ?>" method="GET" id="yearFilterForm" class="me-2">
  ...
  <div class="row g-3 mb-4">
    <div class="col-12 col-md-3">
      <div class="zmc-card h-100">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="text-muted small fw-bold">Generated <?php echo e((isset($year) && $year != now()->year) ? 'in '.$year : 'today'); ?></div>
    ...
    <div class="col-12 col-md-3">
      <div class="zmc-card h-100">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            <div class="text-muted small fw-bold">Issued <?php echo e((isset($year) && $year != now()->year) ? 'in '.$year : 'today'); ?></div>
