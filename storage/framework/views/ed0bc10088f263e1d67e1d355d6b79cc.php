...
<div class="zmc-dashboard-wrapper" style="font-family:'Roboto', sans-serif; color:#334155;">
  ...
  <div class="row g-3 mb-4">
      ...
      <div class="zmc-card h-100">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            ...
            <div class="h3 fw-black mb-0"><?php echo e($summaryAwaitingVerification); ?></div>
          </div>
      ...
      <div class="zmc-card h-100">
        <div class="d-flex justify-content-between align-items-start">
          <div>
            ...
            <div class="h3 fw-black mb-0"><?php echo e($summaryFromRegistrar); ?></div>
          </div>
    ...
    <div class="col-12 col-md-3">
      <a href="<?php echo e(route('staff.accounts.cash-payment.create')); ?>" class="text-decoration-none">
        <div class="zmc-card h-100">
          <div class="d-flex justify-content-between align-items-start">
            <div>
      ...
      <table class="table table-hover align-middle mb-0 zmc-mini-table">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <td class="text-end">
              <div class="zmc-action-strip">
                ...
                <button
                  ...
                  data-target="#rejectPaymentModal<?php echo e($app->id); ?>"
                  <?php if(!$canAct): ?> disabled <?php endif; ?>
                  data-bs-toggle="tooltip" data-bs-placement="top"
          ...
          <?php $__env->startPush('zmc_modals'); ?>
            ...
            <div class="modal fade" id="rejectPaymentModal<?php echo e($app->id); ?>" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-lg">
                <form class="modal-content" method="POST" action="<?php echo e($rejectPaymentUrl($app->id)); ?>">
                  <?php echo csrf_field(); ?>
