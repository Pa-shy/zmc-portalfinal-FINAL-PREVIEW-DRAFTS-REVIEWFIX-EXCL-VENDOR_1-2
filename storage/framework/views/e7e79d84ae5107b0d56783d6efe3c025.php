...
<head>
  ...
  <script src="<?php echo e(asset('js/director-dashboard-charts.js')); ?>"></script>
  ...
  <link href="<?php echo e(asset('css/green-theme.css')); ?>" rel="stylesheet">
  ...
  <style>
    ...
    h1, h2, h3, h4, h5, h6 { font-family: var(--font-primary); line-height: var(--line-height-tight); margin: 0; }
    ...
    p { margin: 0 0 1rem; line-height: var(--line-height-normal); }
  ...
  <?php echo $__env->yieldPushContent('scripts'); ?>
   ...
   <script>
     ...
     async function toggleZMCTheme() {
       ...
       try {
         const res = await fetch("<?php echo e(route('settings.theme')); ?>", {
           method: 'POST',
           headers: {
...
<?php /**PATH /Users/patiencemupikeni/Downloads/zmc-portalfinal-FINAL-PREVIEW-DRAFTS-REVIEWFIX-EXCL-VENDOR_1-2/resources/views/layouts/portal.blade.php ENDPATH**/ ?>