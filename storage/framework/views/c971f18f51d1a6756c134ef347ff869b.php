...
<head>
  ...
  <title>Certificate - <?php echo e($application->reference); ?></title>
  <style>
    <?php
    ...
    @page {
        size: A4 <?php echo e($orientation); ?>;
        margin: 0;
    }
    ...
    .certificate-container {
      width: <?php echo e($orientation === 'portrait' ? '210mm' : '297mm'); ?>;
      height: <?php echo e($orientation === 'portrait' ? '297mm' : '210mm'); ?>;
    ...
    .border-frame {
      width: 100%;
      height: 100%;
      border: 5mm <?php echo e($borderStyle); ?> <?php echo e($primaryColor); ?>;
      box-sizing: border-box;
      padding: 5mm;
      position: relative;
      display: flex;
    ...
    <?php if($borderStyle === 'ornate'): ?>
    .border-frame {
        border: 1mm solid <?php echo e($primaryColor); ?>;
        padding: 10mm;
    }
    .border-frame::before {
        content: "";
        ...
        border: 0.5mm solid <?php echo e($secondaryColor); ?>;
        pointer-events: none;
    }
    .corner-ornament {
        position: absolute;
        width: 30mm;
        height: 30mm;
        border: 2mm solid <?php echo e($primaryColor); ?>;
        z-index: 2;
    }
    ...
    .inner-content {
      flex: 1;
      border: 1px solid <?php echo e($secondaryColor); ?>;
      padding: 15mm;
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    .ornamental-line {
        width: 100%;
        height: 1mm;
        background: linear-gradient(to right, transparent, <?php echo e($secondaryColor); ?>, transparent);
    ...
    .cert-title {
        ...
        margin: 5mm 0 1.5rem;
        text-transform: uppercase;
        font-style: <?php echo e($titleStyle); ?>;
    }
    ...
    .recipient-name {
        ...
        color: #000;
        margin: 3mm 0;
        border-bottom: 1pt solid <?php echo e($secondaryColor); ?>;
    ...
    .qr-box {
        ...
        background: #fff;
        padding: 1mm;
        border: 0.5pt solid <?php echo e($secondaryColor); ?>;
    }
    ...
    <div class="certificate-container">
        <div class="border-frame">
            ...
            <div class="inner-content">
                <img src="<?php echo e(asset('zmc_logo.png')); ?>" class="watermark" alt="">

                <div class="header-section">
                    <img src="<?php echo e(asset('zmc_logo.png')); ?>" class="zmc-logo" alt="ZMC Logo">
                ...
                <div class="cert-subtitle"><?php echo e($payload['certificate_sub'] ?? 'Of Registration For A Mass Media Service'); ?></div>

                <div class="cert-body">
                    This is to certify that
                    <div class="recipient-name"><?php echo e($payload['org_name'] ?? '—'); ?></div>
                </div>
                ...
                <div class="details-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value"><?php echo e($payload['reg_no'] ?? '—'); ?></div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Issued On</div>
                        <div class="detail-value"><?php echo e($payload['issue_date'] ?? '—'); ?></div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Expiry Date</div>
                        <div class="detail-value"><?php echo e($payload['valid_until'] ?? '—'); ?></div>
                    </div>
                    <div class="detail-item">
...
<?php /**PATH /home/runner/workspace/resources/views/staff/production/certificate_variations.blade.php ENDPATH**/ ?>