<?php $__env->startSection('title', 'Financial Reporting'); ?>
...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form action="<?php echo e(route('staff.accounts.reports.financial')); ?>" method="GET" class="row g-3">
                <div class="col-md-2">
    ...
    <div class="row g-4 mb-4">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $val, $icon, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="p-2 rounded bg-<?php echo e($color); ?> bg-opacity-10 text-<?php echo e($color); ?> me-2">
                            <i class="<?php echo e($icon); ?> fs-4"></i>
                        </div>
                        <div class="text-muted small fw-bold"><?php echo e($label); ?></div>
                    </div>
                    <div class="h4 fw-bold mb-0">
                        <?php echo e(is_numeric($val) && $label != 'Transactions' ? '$'.number_format($val, 2) : $val); ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(ctxTrend, {
            type: 'line',
            data: {
                labels: <?php echo json_encode($revenueTrend->keys()); ?>,
                datasets: [{
                    label: 'Revenue ($)',
                    data: <?php echo json_encode($revenueTrend->values()); ?>,
                    borderColor: '#3b82f6',
                    tension: 0.1,
                    fill: true,
        ...
        new Chart(ctxPie, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($statusBreakdown->keys()); ?>,
                datasets: [{
                    data: <?php echo json_encode($statusBreakdown->values()->pluck('amount')); ?>,
        ...
        new Chart(ctxService, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($revenueByService->keys()); ?>,
                datasets: [{
                    label: 'Amount ($)',
                    data: <?php echo json_encode($revenueByService->values()); ?>,
        ...
        new Chart(ctxCategory, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($revenueByCategory->keys()); ?>,
                datasets: [{
                    label: 'Amount ($)',
                    data: <?php echo json_encode($revenueByCategory->values()); ?>,
        ...
        new Chart(ctxResidency, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($revenueByResidency->keys()); ?>,
                datasets: [{
                    label: 'Amount ($)',
                    data: <?php echo json_encode($revenueByResidency->values()); ?>,
...
<?php echo $__env->make('layouts.portal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/resources/views/staff/accounts/reports/financial.blade.php ENDPATH**/ ?>