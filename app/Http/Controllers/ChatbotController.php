...
class ChatbotController extends Controller
{
    private $knowledgeBase = [
        ...
        'accreditation_overview' => [
            ...
            'response' => "**Journalist Accreditation (AP3 Form)**\n\nTo practice journalism in Zimbabwe, you need to be accredited by ZMC. Here's how:\n\n**Steps:**\n1. Create an account on our portal\n2. Complete the AP3 application form\n3. Upload required documents\n4. Pay the application fee\n5. Await verification and approval\n6. Collect your press card from your chosen regional office\n\n**Types of Accreditation:**\n- **Local Journalists** - Zimbabwean citizens working for local media\n- **Foreign Journalists** - International correspondents\n\n**Fees:**\n- Local Journalist: USD $50\n- Foreign Journalist: USD $200\n\nType 'documents for accreditation' to see required documents."
        ],
